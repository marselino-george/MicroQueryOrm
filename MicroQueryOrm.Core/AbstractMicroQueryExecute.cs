...
{
    public abstract partial class AbstractMicroQuery : IMicroQueryExecute
    {
        /// <summary>
        ...
        /// <param name="transaction"></param>
        /// <param name="timeoutSecs"></param>
        public abstract void Execute<TParams>(string queryStr, TParams parameters, CommandType commandType = CommandType.Text, IDbTransaction? transaction = null, int? timeoutSecs = null)
